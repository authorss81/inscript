...
{BOLD(CYAN('                             |_|        '))}
  {GREEN('InScript v0.5.0')} — Interactive Shell
...
KEYWORDS = [
    "let","const","fn","struct","scene","ai","state","if","else","while",
    "for","in","return","break","continue","match","true","false","null",
    "print","len","range","str","int","float","bool","abs","min","max",
    "sqrt","sin","cos","floor","ceil","round","pow","append",
]
...
<main>
  ...
  <div class="pane">
    ...
    <div class="status" id="status">InScript v0.5.0 · Bytecode VM · Python 3.12</div>
  </div>
</main>
...
async function runCode() {
  ...
  try {
    ...
    out.appendChild(td);
    setStatus(`Done in ${ms}ms · InScript v0.5.0`);
  } catch(e) {
