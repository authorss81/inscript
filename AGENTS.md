...
- **Version source**: `inscript.py` line 27 is the single source; `_version.py` reads it dynamically. All Python modules import VERSION from `_version.py`. Current: 3.9.6.3.
